...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        _ = ParseClientConfiguration {
            $0.applicationId = "TIyznBGalXP2krdijFRJSxbNTaMH9QNvI4bmQ9CG"
            $0.clientKey = "nllfosH65jjZ3mY5lmkdhOmtxsuHMSDxJq6ZzWGn"
            $0.server = "https://parseapi.back4app.com"
        }
        //Parse.initialize(with: parseConfig)
        ParseSwift.initialize(applicationId: "TIyznBGalXP2krdijFRJSxbNTaMH9QNvI4bmQ9CG",
              clientKey: "nllfosH65jjZ3mY5lmkdhOmtxsuHMSDxJq6ZzWGn",
